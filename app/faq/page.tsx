...
const faqItems: FAQItem[] = [
    ...
    },
    {
        ...
        answer: '2,293件のテストケースで検証した結果、確率的中率94.1%、ステータス的中率98.6%を達成しています。安全側に設計されているため、過大予測（実際は動くのに運休と予測）が5.1%に対し、過小予測（運休を見逃す）はわずか0.8%です。これにより「予測を信じて行動したのに運休だった」というリスクを最小化しています。',
        icon: <Search className="w-5 h-5" />,
        relatedLink: { href: '/accuracy', label: '予測精度の詳細を見る' },
    },
    {
        question: 'お気に入りルートはどうやって登録しますか？',
        answer: '①トップページで出発駅と到着駅を入力し検索 ②予測結果画面に表示される「☆お気に入り登録」ボタンをタップ ③登録完了。登録したお気に入りはトップページに表示され、ワンタップで最新の予測結果を確認できます。通勤・通学ルートの登録がおすすめです。',
