...
export const HOKKAIDO_STATIONS: Station[] = [
    ...
    { id: 'shimamatsu', name: '島松', kana: 'しままつ', lines: ['jr-hokkaido.chitose'], region: '道央', lat: 42.9032, lon: 141.5633 },
    ...
    { id: 'heiwa', name: '平和', kana: 'へいわ', lines: ['jr-hokkaido.chitose'], region: '道央', lat: 43.0288, lon: 141.4533 },
    ...
    { id: 'asari', name: '朝里', kana: 'あさり', lines: ['jr-hokkaido.hakodate-main'], region: '道央', lat: 43.1600, lon: 141.0800 },
    { id: 'yoichi', name: '余市', kana: 'よいち', lines: ['jr-hokkaido.hakodate-main'], region: '道央', lat: 43.1878, lon: 140.7847 },
    { id: 'minami-otaru', name: '南小樽', kana: 'みなみおたる', lines: ['jr-hokkaido.hakodate-main'], region: '道央', lat: 43.1870, lon: 141.0070 },
    { id: 'niki', name: '仁木', kana: 'にき', lines: ['jr-hokkaido.hakodate-main'], region: '道央', lat: 43.1500, lon: 140.7700 },
    { id: 'kozawa', name: '小沢', kana: 'こざわ', lines: ['jr-hokkaido.hakodate-main'], region: '道央', lat: 42.9800, lon: 140.6800 },
    { id: 'kutchan', name: '倶知安', kana: 'くっちゃん', lines: ['jr-hokkaido.hakodate-main'], region: '道央', isMajor: true, lat: 42.9000, lon: 140.7500 },
    { id: 'niseko', name: 'ニセコ', kana: 'にせこ', lines: ['jr-hokkaido.hakodate-main'], region: '道央', lat: 42.8000, lon: 140.6800 },
    { id: 'rankoshi', name: '蘭越', kana: 'らんこし', lines: ['jr-hokkaido.hakodate-main'], region: '道央', lat: 42.8000, lon: 140.5200 },
    { id: 'kuromatsunai', name: '黒松内', kana: 'くろまつない', lines: ['jr-hokkaido.hakodate-main'], region: '道央', lat: 42.6700, lon: 140.3000 },
    { id: 'hassamu-chuo', name: '発寒中央', kana: 'はっさむちゅうおう', lines: ['jr-hokkaido.hakodate-main'], region: '道央', lat: 43.0918, lon: 141.2864 },
    { id: 'inazumi-koen', name: '稲積公園', kana: 'いなづみこうえん', lines: ['jr-hokkaido.hakodate-main'], region: '道央', lat: 43.1000, lon: 141.2600 },
    { id: 'teine', name: '手稲', kana: 'ていね', lines: ['jr-hokkaido.hakodate-main'], region: '道央', lat: 43.1118, lon: 141.2464 },
    { id: 'inaho', name: '稲穂', kana: 'いなほ', lines: ['jr-hokkaido.hakodate-main'], region: '道央', lat: 43.1200, lon: 141.2200 },
    { id: 'hoshimi', name: 'ほしみ', kana: 'ほしみ', lines: ['jr-hokkaido.hakodate-main'], region: '道央', lat: 43.1300, lon: 141.2000 },
    { id: 'kotoni', name: '琴似', kana: 'ことに', lines: ['jr-hokkaido.hakodate-main'], region: '道央', lat: 43.0815, lon: 141.3060 },
    { id: 'soen', name: '桑園', kana: 'そうえん', lines: ['jr-hokkaido.hakodate-main', 'jr-hokkaido.sassho'], region: '道央', lat: 43.0708, lon: 141.3325 },
    ...
    { id: 'toyohoro', name: '豊幌', kana: 'とよほろ', lines: ['jr-hokkaido.hakodate-main'], region: '道央', lat: 43.1250, lon: 141.6150 },
    { id: 'horomui', name: '幌向', kana: 'ほろむい', lines: ['jr-hokkaido.hakodate-main'], region: '道央', lat: 43.1510, lon: 141.6570 },
    { id: 'kamishunai', name: '上幌向', kana: 'かみほろむい', lines: ['jr-hokkaido.hakodate-main'], region: '道央', lat: 43.1750, lon: 141.7050 },
    ...
    { id: 'akabira', name: '赤平', kana: 'あかびら', lines: ['jr-hokkaido.nemuro-main'], region: '道央', lat: 43.5500, lon: 142.0500 },
    { id: 'ebeotsu', name: '江部乙', kana: 'えべおつ', lines: ['jr-hokkaido.hakodate-main'], region: '道央', lat: 43.6200, lon: 141.9300 },
    { id: 'moseushi', name: '妹背牛', kana: 'もせうし', lines: ['jr-hokkaido.hakodate-main'], region: '道央', lat: 43.7000, lon: 141.9600 },
    { id: 'ashibetsu', name: '芦別', kana: 'あしべつ', lines: ['jr-hokkaido.nemuro-main'], region: '道央', lat: 43.5100, lon: 142.1800 },
    ...
    { id: 'ishikari-numata', name: '石狩沼田', kana: 'いしかりぬまた', lines: ['jr-hokkaido.rumoi'], region: '道北', lat: 43.7900, lon: 141.9300 },
    ...
    { id: 'nagayama', name: '永山', kana: 'ながやま', lines: ['jr-hokkaido.soya-main', 'jr-hokkaido.sekihoku-main'], region: '道北', lat: 43.8100, lon: 142.4400 },
    { id: 'pippu', name: '比布', kana: 'ぴっぷ', lines: ['jr-hokkaido.soya-main'], region: '道北', lat: 43.8700, lon: 142.4700 },
    { id: 'ranru', name: '蘭留', kana: 'らんる', lines: ['jr-hokkaido.soya-main'], region: '道北', lat: 43.9400, lon: 142.4800 },

    // 道央圏 - 学園都市線
    { id: 'hachiken', name: '八軒', kana: 'はちけん', lines: ['jr-hokkaido.sassho'], region: '道央', lat: 43.0880, lon: 141.3250 },
    { id: 'shinkawa', name: '新川', kana: 'しんかわ', lines: ['jr-hokkaido.sassho'], region: '道央', lat: 43.1000, lon: 141.3250 },
    { id: 'shin-kotoni', name: '新琴似', kana: 'しんことに', lines: ['jr-hokkaido.sassho'], region: '道央', lat: 43.1000, lon: 141.3300 },
    { id: 'taihei', name: '太平', kana: 'たいへい', lines: ['jr-hokkaido.sassho'], region: '道央', lat: 43.1300, lon: 141.3500 },
    { id: 'yurigahara', name: '百合が原', kana: 'ゆりがはら', lines: ['jr-hokkaido.sassho'], region: '道央', lat: 43.1400, lon: 141.3700 },
    { id: 'shinoro', name: '篠路', kana: 'しのろ', lines: ['jr-hokkaido.sassho'], region: '道央', lat: 43.1450, lon: 141.3850 },
    { id: 'takuhoku', name: '拓北', kana: 'たくほく', lines: ['jr-hokkaido.sassho'], region: '道央', lat: 43.1550, lon: 141.4150 },
    ...
    { id: 'mukawa', name: 'むかわ', kana: 'むかわ', lines: ['jr-hokkaido.hidaka'], region: '道東', lat: 42.5700, lon: 141.9200 },
    ...
    { id: 'nakafurano', name: '中富良野', kana: 'なかふらの', lines: ['jr-hokkaido.furano'], region: '道北', lat: 43.4100, lon: 142.4200 },
    { id: 'kamifurano', name: '上富良野', kana: 'かみふらの', lines: ['jr-hokkaido.furano'], region: '道北', lat: 43.4600, lon: 142.4600 },
    { id: 'bibaushi', name: '美馬牛', kana: 'びばうし', lines: ['jr-hokkaido.furano'], region: '道北', lat: 43.5400, lon: 142.4500 },
    ...
    { id: 'otoineppu', name: '音威子府', kana: 'おといねっぷ', lines: ['jr-hokkaido.soya-main'], region: '道北', lat: 44.7300, lon: 142.2600 },
    { id: 'teshio-nakagawa', name: '天塩中川', kana: 'てしおなかがわ', lines: ['jr-hokkaido.soya-main'], region: '道北', lat: 44.8100, lon: 142.0600 },
    { id: 'kamikawa', name: '上川', kana: 'かみかわ', lines: ['jr-hokkaido.sekihoku-main'], region: '道北', lat: 43.8483, lon: 142.7725 },
    { id: 'antaroma', name: '安足間', kana: 'あんたろま', lines: ['jr-hokkaido.sekihoku-main'], region: '道北', lat: 43.8800, lon: 142.7200 },
    { id: 'aibetsu', name: '愛別', kana: 'あいべつ', lines: ['jr-hokkaido.sekihoku-main'], region: '道北', lat: 43.9100, lon: 142.5800 },
    { id: 'shirataki', name: '白滝', kana: 'しらたき', lines: ['jr-hokkaido.sekihoku-main'], region: '道北', lat: 43.8800, lon: 143.1800 },
    { id: 'maruseppu', name: '丸瀬布', kana: 'まるせっぷ', lines: ['jr-hokkaido.sekihoku-main'], region: '道北', lat: 43.9900, lon: 143.3400 },
    { id: 'ikutahara', name: '生田原', kana: 'いくたはら', lines: ['jr-hokkaido.sekihoku-main'], region: '道北', lat: 43.9600, lon: 143.4800 },
    { id: 'rubeshibe', name: '留辺蘂', kana: 'るべしべ', lines: ['jr-hokkaido.sekihoku-main'], region: '道北', lat: 43.7800, lon: 143.6100 },
    { id: 'tanno', name: '端野', kana: 'たんの', lines: ['jr-hokkaido.sekihoku-main'], region: '道北', lat: 43.8500, lon: 143.9500 },
    { id: 'engaru', name: '遠軽', kana: 'えんがる', lines: ['jr-hokkaido.sekihoku-main'], region: '道北', lat: 44.0617, lon: 143.5283 },
    { id: 'memambetsu', name: '女満別', kana: 'めまんべつ', lines: ['jr-hokkaido.sekihoku-main'], region: '道北', lat: 43.9200, lon: 144.1700 },
    ...
    { id: 'shiranuka', name: '白糠', kana: 'しらぬか', lines: ['jr-hokkaido.nemuro-main'], region: '道東', lat: 42.9500, lon: 144.0700 },
    ...
    { id: 'hamanaka', name: '浜中', kana: 'はまなか', lines: ['jr-hokkaido.nemuro-main'], region: '道東', lat: 43.1400, lon: 145.0600 },
    { id: 'attoko', name: '厚床', kana: 'あっとこ', lines: ['jr-hokkaido.nemuro-main'], region: '道東', lat: 43.2300, lon: 145.2400 },
    ...
    { id: 'kawayu-onsen', name: '川湯温泉', kana: 'かわゆおんせん', lines: ['jr-hokkaido.senmo-main'], region: '道東', lat: 43.6200, lon: 144.4500 },
    { id: 'midori', name: '緑', kana: 'みどり', lines: ['jr-hokkaido.senmo-main'], region: '道東', lat: 43.7200, lon: 144.5000 },
    ...
    { id: 'nanae', name: '七飯', kana: 'ななえ', lines: ['jr-hokkaido.hakodate-south'], region: '道南', lat: 41.8800, lon: 140.6800 },
    { id: 'onuma', name: '大沼', kana: 'おおぬま', lines: ['jr-hokkaido.hakodate-south'], region: '道南', lat: 41.9700, lon: 140.6700 },
    { id: 'onuma-koen', name: '大沼公園', kana: 'おおぬまこうえん', lines: ['jr-hokkaido.hakodate-south'], region: '道南', lat: 41.9800, lon: 140.6700 },
